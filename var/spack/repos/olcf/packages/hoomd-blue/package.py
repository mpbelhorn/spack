...
class HoomdBlue(Package):
    ...
    version('2.1.0', git="https://bitbucket.org/glotzer/hoomd-blue.git",
            commit="c398b26", submodules=True)
    ...
    variant('fpic', default=True, description='Position independent code support')
    ...
    def install(self, spec, prefix):
        ...
        if '+fpic' in spec:
            ...
            if "+cuda" in spec:
                CUDA_NVCC_FLAGS.extend(['-Xcompiler', '-fPIC'])
