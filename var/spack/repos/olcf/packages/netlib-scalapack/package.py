...
class NetlibScalapack(Package):
    ...
    patch('spectrum-mpi.patch', when='^spectrum')
    ...
    def install(self, spec, prefix):
        ...
        if spec.satisfies('^spectrum'):
            options.extend([
                "-DMPI_BASE_DIR=%s" % spec['mpi'].mpi_exec,
                "-DMPI_BASE_MPIEXEC_NUMPROC_FLAG=%s" % spec['mpi'].mpi_np_flag,
            ])
